...
final class LaunchDetailViewUITests: XCTestCase {
    ...
    func testLaunchesDetailView() throws {
        ...
        // swiftlint:disable:next line_length
        app.collectionViews/*@START_MENU_TOKEN@*/.buttons["ABS-2A / Eutelsat 117W B, Flight number 31, Date 15. 6. 2016 14:29, Mission Success"]/*[[".cells.buttons[\"ABS-2A \/ Eutelsat 117W B, Flight number 31, Date 15. 6. 2016 14:29, Mission Success\"]",".buttons[\"ABS-2A \/ Eutelsat 117W B, Flight number 31, Date 15. 6. 2016 14:29, Mission Success\"]"],[[[-1,1],[-1,0]]],[0]]@END_MENU_TOKEN@*/.tap()
